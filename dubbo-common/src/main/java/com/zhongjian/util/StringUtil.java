...
/**
 * 类StringUtil.java的实现描述：该类继承了apache-common包的字符工具类。
 * 
 * @author xin.caix 2015年1月27日 上午9:31:06
 */
public class StringUtil extends StringUtils {
     ...
     * 验证身份证图片url正则表达式
     */
    public static final String PATTERN_URL = "^(?:https?://)?[\\w]{1,}(?:\\.?[\\w]{1,})+[\\w-_/?&=#%:]*$";
    /**
    ...
    public static String getNotNullValue(String word) {
        return (word == null || word.equalsIgnoreCase(StringUtil.NULL)) ? "" : word;
    }
    ...
    public static String getNotNullValue(String word, String defaultWord) {
        return (word == null || word.equalsIgnoreCase(StringUtil.NULL)) ? defaultWord : word;
    }
    ...
    public static String toRMB(double money) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            resultBuffer.append(s1[n]).append(s4[i]);
        }
    ...
    public static String genNumberRandomCode(int fix) {
        ...
        for (int i = 0; i < fix; i++) {
            int rand = (int) (new Random().nextLong());
