...
@WebServlet(value = "/v1/cvcart/getStoreList", asyncSupported = true)
public class GetCartListServlet extends HttpServlet {
    ...
    private CartCvstoreService cartCvstoreService = (CartCvstoreService) SpringContextHolder
            .getBean(CartCvstoreService.class);
            ...
            public void onAllDataRead() {
                ThreadPoolExecutorSingle.executor.execute(() -> {
                    ...
                    try {
                        ...
                        log.error("fail cvcart/getStoreList : " + e.getMessage());
                    }
    ...
    private String handle(Integer uid, Integer sid) {
        ...
        return GsonUtil.GsonString(cartCvstoreService.queryList(cartBasketListQueryDTO));
    }
}